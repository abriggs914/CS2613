from parse_csv import split_csv1, split_csv2, split_csv3, strip_quotes, split_row_3, split_row, split_csv4
...
def test_split_1():
    assert split_csv1(test_string_1) == table1

def test_split_2():
    assert split_csv2(test_string_1) == table1
...
def test_split_4():
    ...
    assert  split_csv4(test_string_3) == table2
